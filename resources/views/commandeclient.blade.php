		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="card-box mb-30">
					<div class="pd-20">
						<h4 class="text-blue h4">Liste des Commandes clients</h4>						
					</div>
					<div class="pb-20">
						<table class="data-table table stripe hover nowrap">
							...
							<div class="modal-content">
								<div class="modal-header">
									...
									<div class="modal-body col-md-12">						
										<form method="POST" action="{{ route('commandeclient.update')}}" class="form-horizontal col-md-12" autocomplete="off">
										@csrf 
											<div class="row">
                                                <div class="col-md-6  mt-3 text-left">
									...
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">											
												<a class="dropdown-item" data-toggle="modal" data-target="#edit{{$item->id}}" href="{{'/commandeclient/edit/'.$item->id}}".$id><i class="dw dw-edit2"></i> Edit</a>
												<a class="dropdown-item" onclick= "return (confirm(' Voulez-vous supprimer vraiment cette information ?'));"  href="{{'/commandeclient/delete/'.$item->id}}"><i class="dw dw-delete-3"></i> Delete</a>											
											</div>
										</div>
									</td>
								</tr>
