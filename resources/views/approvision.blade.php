...
<body>
										...
										<form method="POST" action="{{ route('approvision.update')}}" class="form-horizontal col-md-12" autocomplete="off">
											...
											<div class="row">
                                                    <div class="col-md-6  mt-3 text-left">                           
                                                        ...
                                                        <div class="form-group">
                                                            <label for="quantite">Quantité</label>
                                                            <input type="number" class="form-control" placeholder="quantité" min="0" value="{{$item->quantite}}" name="quantite" id="quantite" oninput="this.value = Math.abs(this.value)" required/>
                                                        </div>                                                    
                                                    </div>
                                                    <div class="col-md-6  mt-3 text-left">  
                                                        <div class="form-group">
                                                            <label for="prix">Prix unitaire</label>
                                                            <input type="number" class="form-control" placeholder="Prix unitaire" min="0" value="{{$item->prix}}" name="prix" id="prix" oninput="this.value = Math.abs(this.value)" required/>
                                                        </div>                       
                                                        <div class="form-group">
                                                            <label for="devise">Devise</label>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="date">Date</label>
                                                            <input type="date" class="form-control" name="dateprovision" value="{{$item->dateprovision}}" id="dateprovision" required/>
                                                        </div>                        
                                                    </div>
                                                </div>
                                                <div class="form-group">                               
									...
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
												<a class="dropdown-item" data-toggle="modal" data-target="#edit{{$item->id}}" href="{{'/approvision/edit/'.$item->id}}".$id><i class="dw dw-edit2"></i> Edit</a>
												<a class="dropdown-item" onclick= "return (confirm(' Voulez-vous supprimer vraiment cette information ?'));"  href="{{'/approvision/delete/'.$item->id}}"><i class="dw dw-delete-3"></i> Delete</a>											
											</div>
										</div>
									</td>
								</tr>
	...
	<script src="{{url('assets\vendors\scripts\datatable-setting.js')}}"></script>
		<script type="text/javascript">
			$('#formapprovision').submit(function(e){

				e.preventDefault();

				$.ajax({
					url:'{{ route("approvision.store")}}',
					method: 'POST',
