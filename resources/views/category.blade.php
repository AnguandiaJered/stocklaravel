                                ...
                                <form id="forme" method="POST" Action="" class="form-horizontal col-md-12" autocomplete="off">
                                    <div class="row">
                                        <div class="col-md-7  mt-3 text-left">                          
                                            ...
                                            <div class="form-group">                               
                                            <input type="submit" class="btn btn-primary col-md-6 mt-3 mr-5" value="Enregistrer" required/>
                                        </div>                               
                                        </div>                                       
									...
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">										
												...
												<a class="dropdown-item" onclick= "return (confirm(' Voulez-vous supprimer vraiment cette information ?'));"  href="deleteproduit.php?id="><i class="dw dw-delete-3"></i> Delete</a>											
											</div>
										</div>
									</td>
								</tr>
